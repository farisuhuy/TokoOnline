...
class gambarbarang extends CI_Controller {
	...
	{
        $this->form_validation->set_rules('keterangan','Keterangan Barang','required', array(
            ...
            if (!$this->upload->do_upload($field_name)) {
                $data = array(
                   'title' => 'Add Gambar Barang',
                    ...
                    "allBarang" => $this->m_gambarbarang->get_all()
                );
        ...
        $data = array(
            ...
            'gambar' => $this->m_gambarbarang->get_gambar($id_barang),
            'isi' => 'gambarbarang/v_add',
            "allBarang" => $this->m_gambarbarang->get_all($id_barang)
        );
