        ...
        <div class="card-body">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="number" name=" berat" min="0" class="form-control"
                            placeholder="Berat Dalam Satuan Gram" value="<?= set_value('berat')?>">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="deskripsi" class="form-control" rows="5"
                    placeholder="Deskripsi Barang"><?= set_value('deskripsi')?></textarea>
            </div>
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                ...
                <div class="col-sm-6">
                    <div class="form-group float-right">
                        <img src="<?= base_url('assets/gambar/nofoto') ?>" id="gambar_load" width="270px">
                    </div>
                </div>
