        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input name="berat" class="form-control" placeholder="Berat Dalam Satuan Gram"
                            value="<?= $barang->berat?>">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="deskripsi" class="form-control" rows="5"
                    placeholder="Deskripsi Barang"><?=$barang->deskripsi?></textarea>
            </div>
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                ...
                <div class="col-sm-6">
                    <div class="form-group float-right">
                        <img src="<?= base_url('assets/gambar/'. $barang->gambar) ?>" id="gambar_load" width="270px">
                    </div>
                </div>

                <div class="form-group">
                    <a href="<?= base_url('barang') ?>" class="btn btn-default btn-sm">Kembali</a>
